  ...
  public function parseHook($jsonHook, $hookName, $posts, $sdk) {
    switch ($hookName) {
      case "distribution_schedule":
        $this->postScheduling($jsonHook, $posts, $sdk);
        return true;
      case "distribution_go_live":
        $this->postGoLive($jsonHook, $posts, $sdk);
        return true;
      case "content_update":
        $this->postRevision($jsonHook, $posts, $sdk);
        return true;
      case "distribution_update":
        $this->postUpdate($jsonHook, $posts, $sdk);
        return true;
      case "distribution_revoke":
        $this->postRevoke($jsonHook, $posts, $sdk);
        return true;
      case "service_cancel":
        $posts->deactivationPlugin();
        return true;
      case "service_phone_home":
        return $this->servicePhoneHome($posts, $sdk);
      default:
        return false;
    }
  }
